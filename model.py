...
METRIC_LABELS = {
    ...
    # الكاميرا الأمامية/الخلفية (المستوى الأمامي)
    "f_lean_plant_deg": ("الميل الداخلي للجسم لحظة وضع القدم (أمامي)", "°"),
    "f_lean_takeoff_deg": ("الميل الداخلي للجسم لحظة الارتقاء (أمامي)", "°"),
    "f_trunk_tilt_takeoff_deg": ("ميل الجذع الجانبي لحظة الارتقاء (+ بعيداً عن العارضة)", "°"),
    "f_knee_valgus_deg": ("انحراف ركبة الارتقاء للداخل (+ للداخل)", "°"),
    "f_shoulder_tilt_deg": ("ميل محور الكتفين لحظة الارتقاء", "°"),
    "f_hip_tilt_deg": ("ميل محور الورك لحظة الارتقاء", "°"),
    # الكاميرا العلوية
    "t_takeoff_dist_m": ("بعد نقطة الارتقاء عن العارضة (علوي)", "م"),
    "t_takeoff_along_bar_m": ("موقع الارتقاء على طول العارضة من القائم الأول", "م"),
    "t_approach_angle_deg": ("زاوية الاقتراب بالنسبة للعارضة لحظة الارتقاء", "°"),
    "t_speed_mps": ("سرعة الاقتراب النهائية (علوي)", "م/ث"),
    "t_curve_radius_m": ("نصف قطر منحنى الاقتراب (آخر 3–4 خطوات)", "م"),
}
